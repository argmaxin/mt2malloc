# mt2malloc
(MT)² or MTMT stands for Multi-Threaded Maple-Tree Memory Allocator. mt2malloc is a drop-in libc's malloc replacement that comes with powerful API that makes it NUMA-native. mt2malloc is licensed under Apache License, and written in ISO C11.
